                        ...
                        <ul style = {list_key_features}>
                            <li style = {list_li}>
                                <div style = {heading_key}>
                                    <img style = {landing_img} src = {logo1} alt = "Develop creative thing"/>
                            ...
                            <li style = {list_li}>
                                <div style = {heading_key}>
                                    <img style = {landing_img} src = {logo2} alt = "Get to know the technology world"/>
                            ...
                            <li style = {list_li}>
                                <div style = {heading_key}>
                                    <img style = {landing_img} src = {logo3} alt = "Get more job opportunities"/>
